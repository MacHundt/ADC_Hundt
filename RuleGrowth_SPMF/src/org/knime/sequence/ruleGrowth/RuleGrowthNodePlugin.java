 ...
 */
public class RuleGrowthNodePlugin extends Plugin {
    // The shared instance.
    private static RuleGrowthNodePlugin plugin;

    /**
     * The constructor.
     */
    public RuleGrowthNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RuleGrowthNodePlugin getDefault() {
        return plugin;
    }
