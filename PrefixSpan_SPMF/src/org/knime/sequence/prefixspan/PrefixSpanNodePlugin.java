 ...
 */
public class PrefixSpanNodePlugin extends Plugin {
    // The shared instance.
    private static PrefixSpanNodePlugin plugin;

    /**
     * The constructor.
     */
    public PrefixSpanNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PrefixSpanNodePlugin getDefault() {
        return plugin;
    }
