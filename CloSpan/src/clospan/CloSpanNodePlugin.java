 ...
 * @author Hundt
 */
public class CloSpanNodePlugin extends Plugin {
    // The shared instance.
    private static CloSpanNodePlugin plugin;

    /**
     * The constructor.
     */
    public CloSpanNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CloSpanNodePlugin getDefault() {
        return plugin;
    }
